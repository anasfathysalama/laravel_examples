...
class BookValidationTest extends TestCase
{
    ...
    {
        $response = $this->actingAs($this->user)->post("/books", $this->data(['description' => "this is description"]));
    ...
    {
        $response = $this->actingAs($this->user)->post("/books", $this->data(['ISBN' => "sadsasd-i"]));
